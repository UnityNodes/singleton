...
<div class="title-block">
  ...
  <div class="chips">
    ...
    <span>0x4ed6d1a7 &middot; CC3 testnet, verified</span>
  </div>
</div>''')
...
<div class="two">
  ...
  <div>
    ...
    <code>QuorumTooThin(1, 7, 8)</code>, transaction <code>0x7d9c3cef</code>, still there.</p>
...
<ol class="steps tight">
  ...
  searches for nothing. A batch pledge became supported rather than refused.</p></li>
</ol>
<p class="foot-note">Also corrected: a caveat claiming an administrator cannot fabricate, which was false,
and the vacuous test that backed it. 100 tests, every attack kept as a regression.</p>''')
...
<div class="stats">
  <div><span class="big">16</span><p>inclusion proofs on CC3 testnet, every hash published</p></div>
  <div><span class="big">2 / 2</span><p>attested source chains read, Sepolia and Ethereum mainnet</p></div>
  <div><span class="big">100</span><p>tests, including both reviews kept as regressions</p></div>
  <div><span class="big">0</span><p>wallets, backends and indexers between the page and the chain</p></div>
</div>
<div class="chips wide">
  <span>singleton.unitynodes.com</span>
  <span>/demo, 1:38, voiced and captioned</span>
  <span>github.com/UnityNodes/singleton</span>
  <span>0x4ed6d1a7c7E18D95D56d2f1171507fECfb9B4b5c</span>
</div>''')
