...
and the vacuous test that backed it. 98 tests, every attack kept as a regression.</p>''')
...
<div class="stats">
  ...
  <div><span class="big">98</span><p>tests, including both reviews kept as regressions</p></div>
