export const REGISTRY_ABI = [
  ...
  "function registerPledges((uint64 chainKey,uint64[] heights,address[] emitters,uint32[] logIndexes,bytes[] encodedTransactions,(bytes32 root,(bytes32 hash,bool isLeft)[] siblings)[] merkleProofs,(bytes32 lowerEndpointDigest,bytes32[] roots) sharedContinuityProof) b) returns (bytes32[] assetKeys, bool[] duplicate)",
  ...
  "function collisionAt(bytes32 assetKey,uint256 index) view returns ((address emitter,address borrower,uint256 amount,bytes32 instanceId,uint64 chainKey,uint64 sourceHeight,uint64 reportedAt,(uint64 attestedTip,uint64 attestors,uint128 minBond) security))",
  ...
  "function adapterFrozen(uint64,address) view returns (bool)",
  "function adapterOf(uint64,address) view returns (address)",
  "function getStatus(bytes32 assetKey) view returns ((uint8 state,address emitter,address borrower,uint256 amount,bytes32 instanceId,uint64 chainKey,uint64 sourceHeight,uint64 recordedAt,(uint64 attestedTip,uint64 attestors,uint128 minBond) security))",
  ...
  "function minAttestors(uint64) view returns (uint64)",
  ...
  "function setMinAttestors(uint64 chainKey,uint64 floor)",
  ...
  "event AttestationWitnessed(bytes32 indexed assetKey,uint64 chainKey,uint64 attestedTip,uint64 attestors,uint256 minBond)",
