...
contract BatchTest is SourceChain {
    ...
    function test_aBatchFilesEveryPledgeInIt() public {
        ...
        bytes32[] memory keys = registry.registerPledges(b);
    ...
    /// A proof spent alone cannot be spent again inside a batch, and the other
    /// way round. The nullifier does not care which door the proof came through.
    function test_aProofCannotBeSpentAloneAndThenInABatch() public {
